<template>
  <div class="card card-info">
    <div class="card-header" v-if="!pageStatus">
      <h3 class="card-title">Карточка контакта</h3>
      <button class="btn btn-danger float-right" @click.prevent = "editMode()">Редактировать</button>
    </div>
    <div class="card-header" v-if="pageStatus">
      <h3 class="card-title">Редактирование карточки контакта</h3>
    </div>
    <!-- /.card-header -->
    <!-- form start -->
    <form class="form-horizontal" @submit.prevent="updateContact">
      <div class="card-body">
        ...
        <div class="form-group">
          <textarea class="form-control" v-model="contact.description" placeholder="Комментарии по клиенту" style="height: 100px">
