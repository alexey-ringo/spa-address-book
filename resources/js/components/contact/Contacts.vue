    ...
    <div class="card">
        ...
        <div class="card-body table-responsive p-0">
            <table class="table table-hover table-bordered table-striped">
                ...
                <tbody>
                    <tr v-for="contact in contacts" :key="contact.id" @click="showContact(contact.id)">
                        <td>{{ contact.surname  }}</td>
                        <td>{{ contact.name  }}</td>
                        <td>{{ contact.second_name }}</td>
                        <td>{{ contact.phones[0].phone }}</td>
                        <td>{{ contact.email }}</td>
                    <!--    <td>
            ...
            <div class="row justify-content-center">
                <nav aria-label="...">
                    <ul class="pagination">
                        ...
                        <li class="page-item" v-if="paginateDisabledNext">
                            <!--<a class="page-link" href="#" tabindex="-1" @click="getPrevPage">Previous</a>-->
                            <button class="page-link" href="#" @click="getPrevPage">Пред</button>
                        ...
                        <li class="page-item" v-if="paginateDisabledPrev">
                            <button class="page-link" href="#" @click="getNextPage">След</button>
...
<script>
    export default {
        ...
        watch: {
          searchResults(after, before) {
            if(!this.isEmptyObject(this.searchResults)) {
              this.contacts = this.searchResults;
            }
          }
        },
        methods: {
